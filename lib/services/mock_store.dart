...
class MockStore {
  // Requêtes d’élévation de rôle (si tu veux les exploiter côté AuthService)
  ...
  void approveFinal(int id, String approver, String dispatch) {
    ...
    if (exp != null) {
      ...
      exp['dispatch'] = dispatch; // simple traçage
