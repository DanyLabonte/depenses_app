...
class Limits {
  ...
  /// V?rifie le plafond global mensuel dÃ¢â‚¬â„¢un utilisateur.
  ...
  /// Texte explicatif des plafonds, pour affichage dans lÃ¢â‚¬â„¢app.
  static String getLimitsDescription({String? role}) {
    final buffer = StringBuffer();
    buffer.writeln('?? *Plafonds par cat?gorie*${role != null ? ' pour $role' : ''}:');
