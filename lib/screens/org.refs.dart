...
const kDivisions = <DivisionRef>[
  ...
  DivisionRef('PS0883', 'DIVISION 0883 LANAUDIÈRES'),
  ...
  DivisionRef('EP0001', 'ÉQUIPE PROVINCIAL'),
...
/// Programme = liste dépendant du département
@immutable
class ProgramRef {
  final String code;
  final String label;
...
/// mapping département -> programmes
